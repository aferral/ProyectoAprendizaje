...
#FROM https://github.com/FlorianMuellerklein/Machine-Learning/blob/master/Old/BackPropagationNN.py
...
class MLP_NeuralNetwork(object):
    ...
    def feedForward(self, inputs):
        ...
        if len(inputs) != self.input-1:
            raise ValueError('Wrong number of inputs you silly goose!',len(inputs),self.input-1)
        ...
        # output activations le coloque combinacion lineal para hacer funciones
        #Reales arbitrarias
    ...
    def backPropagate(self, targets):
        ...
        for k in range(self.output):
            ...
            #print "Estimate ",self.ao[k]
            #print ""
            #output_deltas[k] =  2*error
